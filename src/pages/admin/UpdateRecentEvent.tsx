...
const UpdateRecentEvent = () => {
        ...
        fetch(img_hosting_url, {
            ...
            .then(imgResponse => {
                ...
                if (imgResponse.success) {
                    ...
                    console.log(newItem);
                    fetch(`https://assignment5-frontend-server.vercel.app/update-recent-event/${_id}`,{
                        method: 'PATCH',
                        headers: {
    ...
    return (
        <div className="w-1/2 mx-auto">
                    <h1 className="text-3xl font-semibold text-center">Update Recent Event <br />{_id}</h1>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input className="btn btn-sm" type="submit" value="Update Recent Event" />
                    </form>                  
                </div>
    );
};
